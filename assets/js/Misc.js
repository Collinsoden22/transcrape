"use strict";
(self.webpackChunk = self.webpackChunk || []).push([[6592, 3171, 3882, 8664, 6126, 4906], {
    1029: function (e, t) {
        t.Z = e => {
        ...
        var c = e => {
            switch (e.name) {
                case "click:OPEN_AFFILIATE_NOTICE_MODAL":
                    o = () => {
                        !window.matchMedia("(min-width: 641px)").matches || ((0,
                            n.sY)("modal"),
                ...
                case "click:MODAL_CLOSE":
                    null !== o && (window.removeEventListener("resize", o),
                        o = null)
            }
        }
    },
        ...
        var n = a(9894)
            ...
            , r = e => {
                ...
                return '\n  <div class="padding-vert-medium">\n    <h3 class="icon-left-medium icon-help-charcoal head-3 margin-horz-medium margin-vert-small">'.concat(a, '</h3>\n    <ol class="list-no-style border-top border-gray-light">\n      ').concat(n.map(((e, a) => '\n        <li>\n          <a           \n            href="'.concat(e.url, '"\n            data-track-ga=\'{\n              "category": "course page: help guides",\n              "action": "').concat(t, '",\n              "label": "').concat(e.url, '"\n            }\'\n            target="_blank"\n            class="color-charcoal hover-no-underline border-bottom border-gray-light padding-vert-small padding-horz-medium hover-bg-blue-xlight block"\n          >\n            <span class="weight-bold padding-right-xsmall">').concat(a + 1, ".</span> ").concat(e.title, "\n          </a>\n        </li>\n      "))).join(""), '\n    </ol>\n    <p class="color-gray margin-top-large margin-horz-medium">\n      ').concat((0,
                    c.sprintf)((0,
                        o.T)(i.s.csr.help.visit_help_center()), '<a target="_blank" href="/help">', "</a>"), "\n    </p>\n  </div>\n")
            }
            , s = e => {
            ...
            switch (e.name) {
                ...
                case "click:DROPDOWN_OPEN":
                    e.originalEvent.preventDefault(),
                        (0,
                            l.px)("[data-name=DROPDOWN_".concat(e.detail.target, "]")).then((t => {
                                (0,
                                    l.IV)("hidden", t),
                ...
                case "click:ACCORDIAN_EXPAND":
                    {
                        ...
                        (0,
                            l.px)("[data-name=ACCORDIAN_".concat(e.detail.target, "]")).then((a => {
                                const n = e.target.querySelector(".icon-chevron-right-charcoal");
                                n && ((0,
                                    l.IV)("icon-chevron-right-charcoal", n),
                                    (0,
                                        l.cn)("icon-chevron-down-charcoal", n)),
                                    (0,
                                        l.IV)(t, a),
                ...
                case "click:ACCORDIAN_COLLAPSE":
                    {
                        ...
                        (0,
                            l.px)("[data-name=ACCORDIAN_".concat(e.detail.target, "]")).then((a => {
                                ...
                                n && ((0,
                                    l.IV)("icon-chevron-down-charcoal", n),
                                    (0,
                                        l.cn)("icon-chevron-right-charcoal", n)),
                                    (0,
                                        l.cn)(t, a),
                ...
                case "click:EXPAND_TRIGGER":
                    (0,
                        l.px)("[data-name=EXPAND_CONTENT_".concat(e.detail.target, "]")).then((e => {
                            (0,
                                l.IV)("hidden", e)
                        }
                        )),
                        (0,
                            l.px)("[data-name=EXPAND_PREVIEW_".concat(e.detail.target, "]")).then((e => {
                                (0,
                                    l.cn)("hidden", e)
                            }
                            ));
                ...
                case "click:REMOVE_PARENT":
                    (0,
                        l.px)("[data-name=".concat(e.detail.target, "]")).then((e => {
                            e.remove()
                        }
                        ));
                    break;
                        ...
                        n.sY)("modal", (0,
                            i.Z)({
                                content: (0,
                                    c.Z)({
                                        message: (null === (t = (0,
                                            n.y0)().onboarding) || void 0 === t ? void 0 : t.verifyEmailMessage) || null,
                                        isLoading: !1,
                                        sent: !1,
                                        error: !1
                                    }),
                ...
                case "submit:RESEND_EMAIL_VERIFICATION":
                    ...
                    (0,
                        n.sY)("modal", (0,
                            i.Z)({
                                content: (0,
                                    c.Z)({
                                        message: (null === (a = (0,
                                            n.y0)().onboarding) || void 0 === a ? void 0 : a.verifyEmailMessage) || null,
                                        isLoading: !0
                                    }),
                                style: {
                                    width: 400,
                        ...
                        (0,
                            o.Z)("ONBOARDING/EMAIL_VERIFICATION");
                    break;
                        ...
                        n.sY)("modal", (0,
                            i.Z)({
                                content: (0,
                                    c.Z)({
                                        message: (null === (s = (0,
                                            n.y0)().onboarding) || void 0 === s ? void 0 : s.verifyEmailMessage) || null,
                                        isLoading: !1,
                                        sent: !0
                                    }),
                                style: {
                        ...
                        n.sY)("modal", (0,
                            i.Z)({
                                content: (0,
                                    c.Z)({
                                        message: (null === (d = (0,
                                            n.y0)().onboarding) || void 0 === d ? void 0 : d.verifyEmailMessage) || null,
                                        isLoading: !1,
                ...
                case "click:MENU_SIDEBAR":
                    {
                        ...
                        if (t.classList.contains("animate-slide-in-right"))
                            return (0,
                                l.IV)("animate-slide-in-right", t),
                                (0,
                                    l.cn)("animate-slide-out-left", t),
                                (0,
                                    l.IV)("icon-x-charcoal", a),
                                void (0,
                                    l.cn)("icon-menu-charcoal", a);
                        t.style.top = "".concat(e, "px"),
                            (0,
                                l.cn)("animate-slide-in-right", t),
                            (0,
                                l.IV)("icon-menu-charcoal", a),
                            (0,
                                l.cn)("icon-x-charcoal", a);
                        break
                    }
            }
        }
    ...
    6499: function (e, t, a) {
        ...
        t.default = e => {
            if ("change:RADIO" === e.name) {
                const t = e.detail.values.map((t => (0,
                    i.Z)({
                ...
                (0,
                    l.LG)(e.target, e.target.name),
                    (0,
                        n.sY)("radio-".concat(e.target.name), t)
            }
        }
    },
    1440: function (e, t, a) {
        ...
        t.default = e => {
            if ("click:TAB_TRIGGER" === e.name)
                e.originalEvent.preventDefault(),
                    (0,
                        n.px)("[data-tab-family=".concat(e.detail.family, "][data-tab=").concat(e.detail.tab, "]")).then((t => {
                            ...
                            (0,
                                ...
                                (0,
                                    n.IV)("hidden", t);
                            try {
                                const { focusState: t, blurState: l } = JSON.parse(e.target.dataset.detail);
                                (0,
                                    n.IV)(t, a),
                                    (0,
                                        n.cn)(l, a),
    ...
    3906: function (e, t, a) {
            ...
            , i = e => {
                ...
                if (!e.content && t.length && [].slice.call(t).forEach((e => {
                    ...
                    t.style.marginTop = "".concat(e.offset, "px"),
                        ...
                        t.setAttribute("class", "cmpt-tooltip absolute box-shadow radius-small border-all z-force-top border-gray-light bg-white"),
                        t.style.visibility = "hidden",
                        t.style.top = "".concat((0,
                            l.Hs)(e.parent).height, "px"),
                        t.innerHTML = e.content,
                        e.parent.append(t),
                        t.style.left = "".concat(-(0,
                            l.Hs)(t).width / 2 + (0,
                                l.Hs)(e.parent).width / 2, "px"),
                        t.style.visibility = ""
                }
            }
            , o = a(8785)
        ...
        var s = e => {
            ...
            ;
        const d = e => !(window.innerWidth < 915) && void (0,
            o.Z)("GET_OVERLAY", {
    ...
    5105: function (e, t, a) {
        ...
        const l = e => {
            ...
            t.scrollTop = 0,
                ...
                (0,
                    n.px)('[data-name="TRUNCATION_BUTTON"][data-id="'.concat(e, '"]')).then((e => {
                        e.remove()
                    }
                    ))
        }
