        ...
        t.default = {
            csr: {
                navigation: {
                    lists_dropdown: {
                        step_count: e => "Step " + (0,
                            a.Rx)("en", e.currentStep, 0) + "/" + (0,
                                a.Rx)("en", e.totalSteps, 0),
                ...
                course: {
                    content: {
                        ...
                        choose_rating: e => "Create a " + (0,
                            a.Rx)("en", e.rating, 0) + " star review of this course",
                ...
                lists: {
                    ...
                    add_to_modal: {
                        ...
                        saving: () => "Saving…",
                        scroll: () => "Scroll",
                        list_limit_reached: e => "List limit reached (" + (0,
                            a.Rx)("en", e.limit, 0) + ")",
                    ...
                    privacy: {
                        ...
                        current: e => "Your list privacy is currently " + (0,
                            a.Ys)(e.privacy, {
                                private: "%sPrivate%s",
                                public: "%sPublic%s",
                ...
                mark_complete: {
                    ...
                    where_title: e => "Where are my completed " + (0,
                        a.Ys)(e.type, {
                            course: "courses",
                            list: "lists",
                            other: ""
                        }) + "?",
                    mark_as_complete_copy: e => "Marking a " + (0,
                        a.Ys)(e.type, {
                            course: "course",
                            list: "list",
                            other: ""
                ...
                catalog: {
                    results: {
                        show_button: e => "Show " + (0,
                            a.Rx)("en", e.courseCount, 0) + " " + (0,
                                a.Ho)(e.courseCount, 0, r.en, {
                                    1: "course",
                                    other: "courses"
                                })
                    }
        ...
        t.default = {
            csr: {
                navigation: {
                    lists_dropdown: {
                        step_count: e => "Paso " + (0,
                            a.Rx)("es", e.currentStep, 0) + "/" + (0,
                                a.Rx)("es", e.totalSteps, 0),
                ...
                course: {
                    content: {
                        ...
                        choose_rating: e => "Dale " + (0,
                            a.Rx)("es", e.rating, 0) + " " + (0,
                                a.Ho)(e.rating, 0, r.es, {
                                    1: "estrella",
                                    other: "estrellas"
                                }) + " a este curso",
                        review_helpful: () => "Útil"
                ...
                lists: {
                    ...
                    add_to_modal: {
                        ...
                        saving: () => "Guardando…",
                        scroll: () => "Bajar",
                        list_limit_reached: e => "Límite de la lista alcanzado: (" + (0,
                            a.Rx)("es", e.limit, 0) + ")",
                    ...
                    privacy: {
                        ...
                        current: e => "Actualmente, tu lista " + (0,
                            a.Ys)(e.privacy, {
                ...
                mark_complete: {
                    ...
                    where_title: e => "¿Dónde están mis " + (0,
                        a.Ys)(e.type, {
                            course: "cursos completados",
                            list: "listas completadas",
                            other: ""
                        }) + "?",
                    mark_as_complete_copy: e => (0,
                        a.Ys)(e.type, {
                ...
                catalog: {
                    results: {
                        show_button: e => "Mostrar " + (0,
                            a.Rx)("es", e.courseCount, 0) + " " + (0,
                                a.Ho)(e.courseCount, 0, r.es, {
                                    1: "curso",
                                    other: "cursos"
                                })
                    }
