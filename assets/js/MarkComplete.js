(self.webpackChunk = self.webpackChunk || []).push([[9992], {
    1029: function (t, e) {
        "use strict";
        e.Z = t => {
    ...
    3499: function (t, e, n) {
        ...
        var r = t => '\n  <div\n    class="cmpt-select-date relative margin-left-small"\n    data-detail=\''.concat(JSON.stringify({
            ...
            i.p6)("".concat(t.year, "/").concat(s(t.month))) : "", '\n    <button\n      tabindex="0"\n      type="button"\n      data-name="SELECT_DATE"\n      data-detail=\'').concat(JSON.stringify({
                ...t
    ...
    4180: function (t, e, n) {
        ...
        var c = t => {
            ...
            , m = t => {
                ...
                return '\n  <section class="padding-medium">\n    <header class="padding-bottom-small padding-right-medium border-bottom relative">\n      <h2 class="head-3 margin-bottom-xxsmall">\n      '.concat(t.completed ? '<span class="icon-left-medium icon-progress-done head-3">' + s.s.csr.mark_complete.completed() + "</span>" : s.s.csr.mark_complete.mark_as_complete(), "\n      ").concat("success" === t.status ? '<span class="inline-block margin-left-xsmall weight-bold bg-green-xlight color-green text-3">' + s.s.csr.mark_complete.saved() + "</span>" : "", "\n      </h2>\n    </header>\n    ").concat(t.completed ? "" : (t => {
                    ...
                    p.sprintf)((0,
                        d.T)(s.s.csr.mark_complete.mark_as_complete_copy({
                            type: t.type
        ...
        const v = t => {
            ...
            if ((0,
                ...
                "success" === n.status)
                return (0,
                    a.sY)("modal-content", m({
                        urls: null === (l = (0,
                            a.y0)().data) || void 0 === l ? void 0 : l.urls,
                        ...n
                    }));
            (0,
                a.sY)("modal", (0,
                    u.Z)({
                        ...
                        content: m({
                            urls: null === (e = (0,
                                a.y0)().data) || void 0 === e ? void 0 : e.urls,
                            ...n
                        }),
                        style: {
                            width: 400,
                        ...
                        window.requestAnimationFrame((() => {
                            "active" === n.status && (0,
                                i.px)("[name=completedStartDate]").then((t => {
                                    t.focus()
                                }
                                ))
                        }
        ...
        var y = t => {
            switch (t.name) {
                ...
                case "submit:PROGRESS_COMPLETE":
                    {
                        ...
                        const { id: a, type: l } = t.detail
                            ...
                            , u = {};
                        if (p && !(0,
                            i.qS)(p) && (u.completedStartDate = !0),
                            m && !(0,
                                i.qS)(m) && (u.completedEndDate = !0),
                            c[r] = {
                                ...c[r],
                                id: a,
                                type: l,
                            ...
                            return h(c),
                                v(r);
                        c[r].status = "".concat(c[r].status, ":processing"),
                            h(c),
                            v(r);
                        const y = {
                            metadata: {
                ...
                case "click:MODAL_CLOSE":
                    var r, c;
                    if (null === (r = t.detail) || void 0 === r || !r.id)
                        return;
    ...
    681: function (t, e, n) {
        ...
        !function () {
            ...
            function o(t, e) {
                var n, a, s, o, r, c, d, p, m, u = 1, g = t.length, b = "";
                for (a = 0; a < g; a++)
                    if ("string" == typeof t[a])
                        ...
                        if ((o = t[a]).keys)
                            for (n = e[u],
                                s = 0; s < o.keys.length; s++) {
                                if (null == n)
                                    throw new Error(i('[sprintf] Cannot access property "%s" of undefined value "%s"', o.keys[s], o.keys[s - 1]));
                                n = n[o.keys[s]]
                            }
                        else
                            n = o.param_no ? e[o.param_no] : e[u++];
                        if (l.not_type.test(o.type) && l.not_primitive.test(o.type) && n instanceof Function && (n = n()),
                            l.numeric_arg.test(o.type) && "number" != typeof n && isNaN(n))
                            throw new TypeError(i("[sprintf] expecting number but found %T", n));
                        switch (l.number.test(o.type) && (p = n >= 0),
                        o.type) {
                            case "b":
                        ...
                        l.json.test(o.type) ? b += n : (!l.number.test(o.type) || p && !o.sign ? m = "" : (m = p ? "+" : "-",
                            n = n.toString().replace(l.sign, "")),
                            c = o.pad_char ? "0" === o.pad_char ? "0" : o.pad_char.charAt(1) : " ",
                            d = o.width - (m + n).length,
                            r = o.width && d > 0 ? c.repeat(d) : "",
                            b += o.align ? m + n + r : "0" === c ? m + r + n : r + m + n)
                    }
                return b
            }
            ...
            function c(t) {
                ...
                for (var e, n = t, a = [], i = 0; n;) {
                    if (null !== (e = l.text.exec(n)))
                        a.push(e[0]);
                    else if (null !== (e = l.modulo.exec(n)))
                        a.push("%");
                    else {
