...
(self.webpackChunk = self.webpackChunk || []).push([[7540], {
    4780: function (t, e, r) {
        ...
        function o(t) {
            ...
            for (let i = 0; i < e; i += 3) {
                const e = t[i + 0]
                    ...
                    , o = t[i + 2];
                r += A.charAt(e >>> 2),
                    r += A.charAt((3 & e) << 4 | n >>> 4),
                    r += A.charAt((15 & n) << 2 | o >>> 6),
                    r += A.charAt(63 & o)
            }
        ...
        let l, h;
        "undefined" != typeof navigator && (l = navigator,
            h = l.userAgent.toLowerCase());
        function u(t) {
            const e = t.split(".")
                , r = e[1]
                , A = function (t) {
                    const e = t.length;
                    let r = 3 * e >>> 2;
                    t.charCodeAt(e - 1) === i && r--,
                        t.charCodeAt(e - 2) === i && r--;
    ...
    this.workers[e] = new Worker(C.createObjectURL(t)),
        ...
        this.workers[e].onmessage = t => {
            ...
            if (e)
                if ("progress" === e.type)
                ...
                else if ("ready" === e.type)
                    this.readyCount++,
                        this.solverType = e.solver,
                        this.readyCount == this.workers.length && this.readyCallback();
                else if ("started" === e.type)
                    this.startCount++,
                        1 == this.startCount && (this.startTime = Date.now(),
                            this.startedCallback());
                else if ("done" === e.type) {
                    this.doneCount++;
                    for (let t = e.startIndex; t < this.puzzleSolverInputs.length; t += this.workers.length)
                        this.solutionBuffer.set(e.solution.subarray(8 * t, 8 * t + 8), 8 * t);
                    ...
                    "error" === e.type && this.errorCallback(e)
        }
            }
setupSolver(t = !1) {
    const e = {
...
class B {
    ...
    onWorkerError(t) {
        this.needsReInit = !0,
            this.e.innerHTML = g(this.opts.solutionFieldName, this.lang, "Background worker error " + t.message),
    ...
    initWorkerGroup() {
        this.workerGroup.progressCallback = t => {
            ...
            this.workerGroup.readyCallback = () => {
                var t, e;
                this.e.innerHTML = (t = this.opts.solutionFieldName,
                    e = this.lang,
            ...
            this.workerGroup.startedCallback = () => {
                ...
                this.e.innerHTML = (t = this.opts.solutionFieldName,
                    e = this.lang,
                    c(t, s, e.text_solving, ".UNFINISHED", void 0, !0)),
    ...
    expire() {
        ...
        this.e.innerHTML = (t = this.opts.solutionFieldName,
            e = this.lang,
            c(t, a, e.text_expired, ".EXPIRED", e.button_restart)),
            this.makeButtonStart()
    }
    async start() {
        if (this.hasBeenDestroyed)
        ...
        if (!t)
            return console.error("FriendlyCaptcha: sitekey not set on frc-captcha element"),
                void (this.e.innerHTML = g(this.opts.solutionFieldName, this.lang, "Website problem: sitekey not set", !1));
        if (function () {
            let t = !0;
            try {
                t = PluginArray.prototype === l.plugins.__proto__,
                    l.plugins.length > 0 && (t = t && Plugin.prototype === l.plugins[0].__proto__)
            } catch (t) { }
            ...
            try {
                this.e.innerHTML = (e = this.opts.solutionFieldName,
                    r = this.lang,
                    c(e, s, r.text_fetching, ".FETCHING", void 0, !0)),
                    this.puzzle = u(await async function (t, e, r) {
                        const A = t.split(",");
                        for (let t = 0; t < A.length; t++)
                            try {
                                    ...
                                    return (await r.json()).data.puzzle;
                                {
                                    ...
                                    if (t === A.length - 1)
                                        throw Error(`Response status ${r.status} ${r.statusText}`)
                                }
                            } catch (e) {
                                throw console.error("[FriendlyCaptcha]:", e),
                                Error(`${r.text_fetch_error} <a class="frc-err-url" href="${A[t]}">${A[t]}</a>`)
                            }
                        throw Error("Internal error")
                    }(this.opts.puzzleEndpoint, t, this.lang)),
                    setTimeout((() => this.expire()), this.puzzle.expiry - 3e4)
            } catch (t) {
                this.e.innerHTML = g(this.opts.solutionFieldName, this.lang, t.message),
                    this.makeButtonStart();
...
9435: function (t, e, r) {
    ...
    function B(t) {
        ...
        var r = e.userAgent
            , B = r.split("[FBAN");
        void 0 !== B[1] && (r = B[0]),
            void 0 !== (B = r.split("Twitter"))[1] && (r = B[0]);
        var w = function (t) {
            return function (e) {
                return e.test(t)
            }
    ...
    var A = function t(e, A) {
        function i(t, i, n) {
            if ("undefined" != typeof document) {
                "number" == typeof (n = r({}, A, n)).expires && (n.expires = new Date(Date.now() + 864e5 * n.expires)),
